...
export default function Twitt(){
   return(
   <Card className="w-[full] h-[320px] bg-black hover:transform hover:scale-105 hover:z-10 transition duration-400 flex flex-row items-center justify-center relative cursor-pointer">
