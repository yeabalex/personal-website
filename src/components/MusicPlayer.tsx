...
export default function MusicPlayer(params: Params) {
  ...
  return (
    <Card
      isBlurred
      className="flex flex-row items-center col-span-2 justify-center border-none w-[full] h-[280px] relative bg-white hover:transform hover:scale-105 hover:z-10 transition duration-400 cursor-pointer"
      shadow="sm"
    >
          ...
          <div className="flex flex-col w-[40%]">
            ...
            <div className="flex justify-between items-start mt-4">
              <div className="flex flex-col gap-2">
                ...
                <h1 className="text-2xl font-bold leading-6">{params.songName}</h1>
